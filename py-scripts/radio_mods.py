...
def INSTALL_MOD(glob_vars, SELECTED_MOD):
	...
	jrfunctions.adb_cmd(glob_vars, ' push ' + RADIO_MOD + ' /sdcard/')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c am force-stop com.syu.radio"')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c mount -o remount,rw /system"')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c cp /system/app/JY-1-C9-Radio-V1.0/JY-1-C9-Radio-V1.0.apk /system/app/JY-1-C9-Radio-V1.0/JY-1-C9-Radio-V1.0.apk.old"')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c cp /sdcard/JY-1-C9-Radio-V1.0.apk /system/app/JY-1-C9-Radio-V1.0"')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c chmod 644 /system/app/JY-1-C9-Radio-V1.0/JY-1-C9-Radio-V1.0.apk"')
	jrfunctions.adb_cmd(glob_vars, ' shell "su -c ls -l /system/app/JY-1-C9-Radio-V1.0"')
